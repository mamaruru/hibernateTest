...
import com.exsample.service.UserService;
...
//    private MainTableService mainTableService;
	...
	public ModelAndView displayAllUser() {
		...
		/*
		List<MainTable> tableList = mainTableService.getAllMainTables();
		for (MainTable entry : tableList ) {
            System.out.println(entry.getId() + " : " + entry.getSubId());
        }
        */
